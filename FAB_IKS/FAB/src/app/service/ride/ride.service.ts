...
export class RideService {
  ...
  createNewRide(requestNewRide: any) : Observable<any> {
    return this.http.post<any>(environment.apiHost + "api/ride", requestNewRide);
  }

  getActiveRideForDriver(driverId: number) : Observable<any> {
    return this.http.get<any>(environment.apiHost + "api/ride/driver/" + driverId + "/active");
  }

  getActiveRideForPassenger(passengerId: number) : Observable<any> {
    return this.http.get<any>(environment.apiHost + "api/ride/passenger/" + passengerId + "/active");
  }
  ...
  withdrawRide(id: number) : Observable<any> {
    return this.http.put<any>(environment.apiHost + "/api/ride/" + id + "/withdraw", {});
  }

  setPanicReason(id: number, requestPanicReason: any) : Observable<any> {
    return this.http.put<any>(environment.apiHost + "api/ride/" + id + "/panic", requestPanicReason);
  }

  startRide(id: number) : Observable<any> {
    return this.http.put<any>(environment.apiHost + "api/ride/" + id + "/start", {});
  }

  acceptRide(id: number) : Observable<any> {
    return this.http.put<any>(environment.apiHost + "api/ride/" + id + "/accept", {});
  }

  endRide(id: number) : Observable<any> {
    return this.http.put<any>(environment.apiHost + "api/ride/" + id + "/end", {});
  }

  cancelRide(id: number, requestCancelReason: any) : Observable<any> {
    return this.http.put<any>(environment.apiHost + "api/ride/" + id + "/cancel", requestCancelReason);
  }

  createFavoriteRoute(requestNewFavRoute: any) : Observable<any> {
    return this.http.post<any>(environment.apiHost + "api/ride/favorites", requestNewFavRoute);
  }
